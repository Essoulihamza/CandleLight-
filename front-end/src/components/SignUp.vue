<template>
    <form v-if="!Authenticated" @submit.prevent="sendData" class="hidden flex-col items-center bg-stone-800  text-stone-200  space-y-8 py-6 px-6  rounded-lg border border-x-stone-400 border-b border-primary h-fit lg:flex">
