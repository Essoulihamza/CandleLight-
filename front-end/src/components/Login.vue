<template>
    <form @submit.prevent="sendRequest" class="fixed t-10 left-1/2 translate-x-[-50%] flex flex-col items-center bg-stone-800  text-stone-200  space-y-6 py-12 px-16  rounded-lg border border-x-stone-400 border-b border-primary h-fit z-10">
